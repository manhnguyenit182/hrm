...
export function ManageLeavesClient({ initialLeaveRequests }: ManageLeavesClientProps) {
  ...
  const [leaveRequests, setLeaveRequests] = useState<LeaveRequestWithEmployee[]>(initialLeaveRequests);
                    ...
                    <div className="flex items-center space-x-3">
                      <div className="relative">
                        {rowData.employee?.image ? (
                          <Avatar image={rowData.employee.image} shape="circle" size="large" />
                        ) : (
            ...
            <div className="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
              <div className="relative">
                {selectedRequest.employee?.image ? (
                  <Avatar image={selectedRequest.employee.image} shape="circle" size="xlarge" />
                ) : (
